...
### Added
- **Phase 3 배포 스크립트**: `01_create_agentcore_runtime.py`
...
- **문서**:
  ...
  - `production_deployment/UPDATE_PHASE1_IAM.md` - IAM 업데이트 가이드 (선택 사항)
...
### Changed
- **01_create_agentcore_runtime.py**: 7단계 → 5단계로 간소화
  - AWS CLI 우회 방식 제거
...
- **문서**:
  ...
  - `STEP_BY_STEP_GUIDE.md` - 단계별 가이드
  - `CLOUDFORMATION_GUIDE.md` - CloudFormation 상세
