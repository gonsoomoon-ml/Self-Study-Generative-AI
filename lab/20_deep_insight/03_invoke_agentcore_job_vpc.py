...
Execution Order:
    01_create_agentcore_runtime.py → agentcore_runtime.py (entrypoint) → 03_invoke_agentcore_job_vpc.py (test)
"""
...
if not AGENT_ARN:
    ...
    print(f"{YELLOW}⚠️  Run 01_create_agentcore_runtime.py first{NC}")
    sys.exit(1)
